...
const OrganizationList = () => {
  ...
  const [isOpenOrganizationUpdateForm, setIsOpenOrganizationUpdateForm] =
    useState(false);
  ...
  const updateOrganization = async (value) => {
    try {
      ...
      const response = await axiosInstance.put(
        `/superadmin/organization/${selectedOrganizationData?.organization_id}/`,
        payload
      );
    ...
    <>
      <div className="">
        <div className="d-flex justify-content-between align-items-center p-3 border rounded bg-white mb-3">
          <h5 className="m-0 main-title">Organizations Pending Request</h5>
        ...
        <Tab.Container id="tabs-example" activeKey={1}>
          <Row>
            <Col sm={3}>
              <Nav variant="pills" className="flex-column">
                <TooltipTopNavItem
                  title={"Managed"}
                  tooltipMessage={"Managed tooltip"}
                  eventKey={"managed"}
                />
                <TooltipTopNavItem
                  title={"Unmanaged"}
                  tooltipMessage={"Unmanaged tooltip"}
                  eventKey={"unmanaged"}
                />
                <TooltipTopNavItem
                  title={"Source"}
                  tooltipMessage={"Source tooltip"}
                  eventKey={"source"}
                />
              </Nav>
            </Col>
            <Col sm={9}>
              <Tab.Content>
                <Tab.Pane eventKey="managed">In managed tab</Tab.Pane>
                <Tab.Pane eventKey="unmanaged">In Unmanaged tab</Tab.Pane>
                <Tab.Pane eventKey="source">In source tab</Tab.Pane>
              </Tab.Content>
            </Col>
          </Row>
        </Tab.Container>
                    ...
                    <td className="customer align-middle white-space-nowrap pe-5">
                      <p className="mb-0">
                        <Form.Check
                          ...
                          className={`me-2 fw-bold d-flex justify-content-center gap-2 ${
        ...
        <UpdateOrganizationForm
          ...
          handleClose={() =>
            setIsOpenOrganizationUpdateForm(!isOpenOrganizationUpdateForm)
          }
