...
import { getDecryptedData,setEncryptedData,removeData  } from '../../../../../utils/helperFunctions';
    ...
    <div className='subject'>
          <div className="d-flex">
            ...
            <div className='w-100' >
              ...
              <div  className='container main-division'>
                <div>
                        ...
                        <ul className="nav nav-underline gap-2 w-100 w-md-50 mb-3" style={{ backgroundColor: 'transparent' }} id="myTab" role="tablist">
                          <li className="nav-item" role="presentation">
                            ...
                            <button className={`nav-link p-2 fw-normal ${tablist === "documents" ? 'active' : ''}`} id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false" style={{ color: tablist === "documents" ? '#5D5FE3' : '#8E9696', fontSize: '16px', backgroundColor: 'transparent' }}
                              onClick={() => { setTablist("documents"); }}>Documents ({courseDetails.docuemnts_count})</button>
                          </li>
                          <li className="nav-item" role="presentation">
                            <button className={`nav-link p-2 fw-normal ${tablist === "flashcards" ? 'active' : ''}`} id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false" style={{ color: tablist === "flashcards" ? '#5D5FE3' : '#8E9696', fontSize: '16px', backgroundColor: 'transparent' }}
                              onClick={() => { setTablist("flashcards"); }}>Flashsets ({courseDetails.public_flashsets_count})</button>
                          </li>
                        </ul>
                                            ...
                                            <div className="modal-content">
                                              <div className="modal-body">
                                                ...
                                                <div className='text-end'>
                                                  <button className='btn btn-sm border-0 btn-success text-white me-2' data-bs-dismiss="modal" >Yes</button><button className='btn btn-sm border-0 btn-danger text-white' data-bs-dismiss="modal">No</button>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
              ...
              <div className="modal-content">
                <div className="modal-body pt-4 pb-3">
                  ...
                  <div className='mt-3 text-end'>
                    <button className='btn btn-sm rounded-pill text-white fw-medium px-4' style={{ backgroundColor: '#5d5fe3' }} data-bs-dismiss="modal">Send</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="modal-dialog modal-md">
              <div className="modal-content">
                <div className="modal-body pt-4 pb-3">
                  ...
                  <div className='mt-3 text-end'>
                    <button disabled={reportvalue.length > 20 ? false : true} className='btn btn-sm rounded-pill text-white fw-medium px-4' style={{ backgroundColor: '#5d5fe3' }} data-bs-dismiss="modal" >Send</button>
                  </div>
                </div>
              </div>
            </div>
