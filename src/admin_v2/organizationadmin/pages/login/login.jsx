...
import { setOrgAccessToken } from '../../../../pages/authService';
...
const initialValues = { email: "admin@learn-hub.de", password: "Welcome@@2025" };
...
const OrganizationAdminLogin = ({ setemailvalidation }) => {
    ...
    const generate_token = async (values) => {
        try {
            ...
            setOrgAccessToken(response.data.access, response.data.refresh);
            ...
            <div className="container">
                ...
                <div className="row mt-lg-2 loginform-div">
                    <div className="col-lg-12">
                        <div className='row'>
                            <h3 className='page6-month mb-0 text-center mb-3' style={{ fontSize: '24px', color: '#5D5FE3' }}>{'Organization Admin'}</h3>
...
export default OrganizationAdminLogin;