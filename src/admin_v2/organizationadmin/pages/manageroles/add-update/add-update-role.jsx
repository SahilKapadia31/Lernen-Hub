...
const ManageRoleAddUpdate = ({
  ...
  const togglePermission = (id) => {
    setPermissions((prev) =>
      prev.map((perm) => ({
        ...perm,
        is_active: perm.permission_id === id ? !perm.is_active : perm.is_active,
      }))
    );
      ...
      >
        <Modal.Body className="bg-light">
          ...
          <Formik
            ...
            onSubmit={(values) => {
              selectedRole ? onUpdate({ ...values, permissions }) : onSubmit({ ...values, permissions });
            }}
          >
            {({ errors, touched }) => (
                ...
                <Form.Group className="mb-2">
                  ...
                  <Field
                    ...
                    className={`form-control ${
                      errors.role_name && touched.role_name ? "is-invalid" : ""
                    }`}
                  />
                  <ErrorMessage
                    name="role_name"
                    ...
                    {permissions.map((perm) => (
                      ...
                      >
                        ...
                        <label
                          ...
                          htmlFor={`switch${perm.permission_id}`}
                        >
