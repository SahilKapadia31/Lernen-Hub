            ...
            <div className='container mt-5 pt-4 pb-4'>
              ...
              <div className='mt-5 pt-3'>
                ...
                <div className='text-center mt-5'>
                  <img src={require('../img/landing_page/Group 461.png')} style={{width:'100%'}} alt="contact-us" />
                </div>
              </div>
            </div>
            ...
            <div className="row container mx-auto m-0 mt-5 pt-4">
              <p className='contact-head mb-5'>Help Center</p>
                ...
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/bookkeeping 1.png')} alt="contact-us" />
                ...
                <div className='col-lg-4 col-md-6 mt-4 mt-md-0'>
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/lighthouse 1.png')} alt="contact-us" />
                ...
                <div className='col-lg-4 col-md-6 mt-4 mt-lg-0'>
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/headphone 1.png')} alt="contact-us" />
                ...
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/first-prize 1.png')} alt="contact-us" />
                ...
                <div className='col-lg-4 col-md-6 mt-4'>
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/video-conference 1.png')} alt="contact-us" />
                ...
                <div className='col-lg-4 col-md-6 mt-4'>
                <div className="d-flex flex-column align-items-center justify-content-center p-4 contact-help-div">
                  <img src={require('../img/landing_page/social-network (1) 1.png')} alt="contact-us" />
