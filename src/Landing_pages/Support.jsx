    ...
    <div className='animate__animated animate__fadeIn'>
      <div>
        ...
        <div className='d-flex align-items-center justify-content-center mt-3' style={{ backgroundColor: '#F3F0FF', height: '200px' }}>
          <p className='error-text2'>Student & Learning Support</p>
        </div>
          ...
          <div className='col-lg-5 col-md-8 mx-auto'>
            <div className='d-flex align-items-center justify-content-evenly py-4'>
              <div className='d-flex align-items-center'>
                <input type="radio" id='existing' name='user' /><label htmlFor="existing" className='support-text1 ms-2'>Existing User</label></div>
              <div className='d-flex align-items-center'><input type="radio" id='new' name='user' /><label htmlFor="new" className='support-text1 ms-2'>New User</label></div>
            </div>
            <div>
              <div>
              ...
              <div className='mt-3'>
                ...
                <select name="" id="" className='form-select' onChange={(e) => { setvalue(e.target.value) }}>
