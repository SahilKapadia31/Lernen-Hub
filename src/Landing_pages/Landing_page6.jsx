        ...
        <div className="row" style={{ height: '100%' }}>
          ...
          <div className="col-12 col-lg-6 d-flex align-items-center justify-content-center">
            <div className="text-center w-100">
              ...
              <a href="https://lernen-hub.de/signuppage" target="_blank" rel="noopener noreferrer">
            ...
            <div className="h-100 px-2 py-2" style={{ backgroundColor: '#F3F0FF' }}>
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/computer (1) 1.png')} alt="page6" className="img-fluid" />
                </div>
              ...
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/sync (1) 1.png')} alt="page6" className="img-fluid" />
                </div>
                <div className="col-9 col-sm-10">
              ...
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/detective (1) 1.png')} alt="page6" className="img-fluid" />
                </div>
                <div className="col-9 col-sm-10">
              ...
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/euro (1) 1.png')} alt="page6" className="img-fluid" />
                </div>
                <div className="col-9 col-sm-10">
              ...
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/group 1.png')} alt="page6" className="img-fluid" />
                </div>
                <div className="col-9 col-sm-10">
              ...
              <div className="row m-0 py-2 pb-3">
                <div className="col-3 col-sm-2 d-flex align-items-center">
                  <img src={require('../img/landing_page/chat (1) 1.png')} alt="page6" className="img-fluid" />
                </div>
                <div className="col-9 col-sm-10">
