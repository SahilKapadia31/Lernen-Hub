        ...
        <div className='py-5' style={{ background: '#F3F0FF' }}>
            ...
            <div className='row container mx-auto m-0 mt-5 pb-4'>
                <div className="col-lg-7">
                    <ul className="nav flex-column">
                        <li className="nav-item page3-tablist" onClick={() => { settablist("1") }}>
                            <p className='page3-tablist-content' style={{ color: tablist === "1" ? '#5d5fe3' : '#2A3941', fontWeight: tablist === "1" ? 600 : 500 }}>1. Organization specific discussion platform</p>
                        </li>
                ...
                <div className="col-lg-5 p-0" style={{ border: '1px solid #5D5FE3' }}>
                    <img src={images[parseInt(tablist) - 1]} style={{ width: '100%', height: '100%' }} alt="page3" />
                </div>
            </div>

            {/* Slider */}
            <div id="landingpage3Slider" className='page3-subdiv' style={{ height: '290px', background: 'linear-gradient(to right, #3c147d, #7d3960)' }}>
                        ...
                        <div>
                            <div className='d-flex flex-column align-items-center justify-content-center'>
                                ...
                                <p className='px-1 px-md-5 page3-subdiv-para' style={{ color: '#e0e0e0' }}>
                                    Organization life is more than academics; it's about growing as a well-rounded individual. Lernen-Hub’s platform promotes an active extra-curricular life, from eSports leagues to debate clubs, igniting passions and cultivating interests outside the lecture hall.
                                </p>
