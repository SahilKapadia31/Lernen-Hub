...
const Admin_navbar = () => {
  ...
  const logout = () => {
    apiClient.delete(`${ipaddress}/admin_app/AdminLogin/`)
      .then((r) => {
  ...
  const fetchnotifications = () => {
    apiClient.get(`${ipaddress}/admin_app/api/DisplayAdminNotifications/`)
      .then((r) => {
  ...
  const deletenotifications = (id) => {
    apiClient.delete(`${ipaddress}/admin_app/api/DisplayAdminNotifications/${id}/`)
      .then((r) => {
    ...
    <div>
      <div className='d-none d-lg-block'>
        <div className='row m-0 mx-auto py-3 px-2' style={{ position: 'sticky', width: '100%', top: 0 }}>
          <div className="col-2 d-flex align-items-center">
            <img src={require('../img/landing_page/Group 385.png')} style={{ width: '100%' }} alt="navbar" />
          </div>
          ...
          <div className='col-10 p-0 pe-3'>
            <ul style={{ listStyleType: 'none' }} className='h-100 pe-4  align-items-center d-flex gap-5 w-75 ms-auto justify-content-end'>
              <li data-bs-toggle="offcanvas" data-bs-target="#notification" aria-controls="notification" style={{ cursor: 'pointer' }} onClick={() => {
                // navigate('/')
              }}><span className='navbar-li d-flex align-items-center'><img src={require('../img/landing_page/Vector.png')} alt="navbar" /><span className='ms-1' style={{ fontSize: '14px' }}>{notifications.length}</span></span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <nav className="navbar bg-transparent d-block d-lg-none py-3 mb-2">
        <div className="container d-flex justify-content-between">
          ...
          <span data-bs-toggle="offcanvas" data-bs-target="#notification" aria-controls="notification" className='navbar-li'><img src={require('../img/landing_page/Vector.png')} width={16} alt="vector" /></span>
        </div>
      </nav>
      ...
      >
        <div className="offcanvas-header d-flex justify-content-between align-items-center">
          <img src={require('../img/landing_page/Group 385.png')} width={120} alt="group" />
