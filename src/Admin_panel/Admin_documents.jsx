...
const Admin_documents = () => {
  ...
  useEffect(() => {
    apiClient.get(`${ipaddress}/admin_app/AdminCourseDocuments/${course_id}/`)
      .then((r) => {
        setdocument_details(r.data); // console.log("Documents data",r.data)
      })
      .catch((err) => {
  ...
  const fetchflashset = () => {
    apiClient.get(`${ipaddress}/admin_app/FlashDetails/${course_id}/`)
      .then((r) => {
