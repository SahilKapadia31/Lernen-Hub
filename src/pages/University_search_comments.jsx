                ...
                <div className="d-flex justify-content-between border-bottom py-2 ps-2 align-items-center mb-0">
                  <div className='d-flex gap-2 align-items-center'>
                    ...
                    <div className={``} onClick={() => {
                      ...
                      <p className='ms-sm-0 my-0 d-flex align-items-center' style={{ fontSize: '12px', color: '#8587EA' }}>{user.university_name} </p>
                    </div>
                  </div>
                        ...
                        <div key={index2} className='px-2 py-2 bg-white' onClick={() => {
                          ...
                          <div className='ps-5 mt-2 m-0'>
                            ...
                            {y.images_attached.map((a) => {
                              return (
                                <div className='d-flex justify-content-center'>
                                  <img src={a.university_discussion_reply_images} width={300} alt="uni-ser" className='mt-3' />
                                </div>
                              )
                            })}
                                      ...
                                      <div className='ps-0 ps-md-3 py-2 bg-white' onClick={() => {
                                        ...
                                        <div className='ps-5 mt-2 m-0'>
                                          ...
                                          {z.images_attached.map((b) => {
                                            return (
                                              <div className='d-flex justify-content-center'>
                                                <img src={b.university_discussion_reply_reply_images} width={300} alt="uni-ser" className='mt-3' />
                                              </div>
                                            )
                                          })}
                                        </div>
