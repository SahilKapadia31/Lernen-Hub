              ...
              <div className='col-12 bg-white px-3 pt-2 pb-3 rounded border'>
                ...
                <div className='py-2' onClick={() => { setindex1(-1) }}>
                  ...
                  {x.document_post_id.images_attached.map((z) => {
                    return (<div><img src={z.image} width={300} className="mt-3 img-fluid" alt="doc-pdf" /></div>)
                  })}
                </div>
                          ...
                          <div className="d-flex">
                            ...
                            {/* <div  className="ms-2 comment-section-img" style={{position:'relative'}}>
                              {x.liked_users.slice(0,5).map((a,index)=>{
                                return(
                                  <>
                                    <img src="http://localhost:3000/static/media/man.ba3e9327f074cac4e49e.png" width={24} style={{left:`${index*20}px`,position:"absolute",top:'-2px'}} alt="doc-pdf" />
                                  </>
                                )
                              })}
                              </div> */}
                      ...
                      return (
                        <div className='py-2 mt-3' onClick={() => { setindex1(-1) }}>
                          ...
                          <div className='ps-0 ps-lg-5 mt-2 m-0'>
                            ...
                            {y.image.map((a) => {
                              return (<div><img src={a.image} style={{ width: '250px' }} alt="doc-pdf" className='mt-3' /></div>)
                            })}
                          </div>
                                        ...
                                        {z.images_attached.map((b) => {
                                          return (
                                            <div className='d-flex justify-content-center'>
                                              <img src={b.dis_reply_reply_images} width={260} alt="doc-pdf" className='mt-3' />
                                            </div>
                                          )
                                        })}
                                      </div>
