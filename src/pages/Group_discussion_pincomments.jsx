        ...
        return (
          <div className='' key={index}>
            <div className='col-12 rounded shadow-sm border mb-3 bg-white'>
              <div className="d-flex justify-content-between border-bottom py-2 ps-2 m-0 align-items-center">
                <div className='d-flex gap-2 align-items-center'>
                  <div className="d-flex justify-content-center" onClick={() => {
                    ...
                    <img src={x.disid.sender.profile_pic} className={x.disid.sender.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="grp-disc" />
                    {x.disid.sender.nickname && (<p style={{ height: '40px', width: '40px' }} className={x.disid.sender.profile_pic == null ? 'd-flex bg-warning text-white p-2 rounded-circle justify-content-center mb-0' : 'd-none'}><span>{x.disid.sender.nickname.slice(0, 1)}</span><span>{x.disid.sender.nickname.slice(-1)}</span></p>)}
                  ...
                  <div className="" onClick={() => {
                    ...
                    <Link to={`/profile/${x.disid.sender.user_id}`} className='my-0 fw-medium text-decoration-none text-dark' style={{ fontSize: '14px' }}>{x.disid.sender.nickname}
                ...
                <div className={`d-flex justify-content-end align-items-center p-0 gap-2`} style={{ position: 'relative' }}>
                <p className='my-0 d-flex align-items-center' style={{ fontSize: '12px', color: '#8587EA', cursor: 'pointer' }} onClick={() => {
                      navigate(`/profile/${x.disid.sender.user_id}`)
                    }}> <span className={`ms-2 edit ${x.disid.edited ? '' : 'd-none'}`}>Edited</span></p>
                  ...
                  <div className="btn-group dropstart">
                    <span className={`border-0`} type="button" style={{ cursor: 'pointer' }} onClick={() => {
                      ...
                      <img src={require('../img/more.png')} width={30} height={30} alt="grp-disc" />
                    </span>
                    <ul className={`bg-white shadow-sm border rounded mt-0 p-0 px-3 ${index1 == index ? '' : 'd-none'}`} style={{ width: '160px', position: 'absolute', left: '-160px' }}>
                      ...
                      {/* ----------------------------------------------------Report button--------------------------------------------------- */}
                      {user.user_id !== x.disid.sender.user_id &&
                        <>
                        ...
                        <div className="modal-body">
                          <div className=' bg-white px-3 pt-2 pb-3 rounded'>
                            ...
                            <div className='d-flex gap-3'>
                              <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="grp-disc" />
                              ...
                              <form className='w-100' onSubmit={(e)=>sendEditedData(e,x.disid.id)}>
              ...
              <div className='py-2 px-2' onClick={() => {
                ...
                {x.disid.images_attached && (
                  x.disid.images_attached.map((z) => {
                    return (
                      <div>
                        <img src={z.images} width={200} alt="grp-disc" className='mt-3' />
                      </div>
                    )
                  })
                )}
                  ...
                  && (
                    <div className="w-75 d-flex justify-content-end">
                      <div className="d-flex w-md-50">
                        {(!replies_layout) ?
                          <button className='ms-4 bg-transparent border-0 fw-bold' style={{ color: '#5D5FE3', fontSize: '14px' }} onClick={(e) => { setreplies_layout(!replies_layout); getreplies(x.disid.id, index); setSelectedReply(index); }}>{translate_value.dashboard.view_all} {x.reply_count} {translate_value.dashboard.replies}</button>
                          : (selectedReply == index) ?
                            <button className='ms-4 bg-transparent border-0 fw-bold' style={{ color: '#5D5FE3', fontSize: '14px' }} onClick={(e) => { setreplies_layout(!replies_layout); setSelectedReply(null) }}>{`View less`}</button>
                            : <button className='ms-4 bg-transparent border-0 fw-bold' style={{ color: '#5D5FE3', fontSize: '14px' }} onClick={(e) => { setreplies_layout(!replies_layout); getreplies(x.disid.id, index); setSelectedReply(index); }}>{translate_value.dashboard.view_all} {x.reply_count} {translate_value.dashboard.replies}</button>
                        }
                      </div>
                    </div>
                      ...
                      <div className='px-2 py-2 bg-white' onClick={() => {
                        ...
                        <div className="d-flex px-2 justify-content-between w-100 align-items-center">
                          <div className='d-flex gap-2'>
                            <div className="d-flex justify-content-end">
                              <img src={y.user_id.profile_pic} className={y.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="grp-disc" />
                        ...
                        <div className='ps-5 mt-2'>
                          ...
                          {y.images_attached.map((a) => {
                            return (
                              <div className=''>
                                <img src={a.images} width={300} alt="grp-disc" className='mt-3' />
                              </div>
                            )
                          })}
                        </div>
                                  ...
                                  <div className='px-2 py-2 bg-white' onClick={() => {
                                    ...
                                    <div className="d-flex justify-content-between w-100 align-items-center">
                                      <div className='d-flex gap-2'>
                                        <div className="d-flex justify-content-center">
                                          <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="grp-disc" />
                                    ...
                                    <div className='ps-5 mt-2'>
                                      ...
                                      {z.images_attached.map((b) => {
                                        return (
                                          <div className='d-flex justify-content-center'>
                                            <img src={b.Group_Discussion_Replies_Reply_Images} width={260} alt="grp-disc" className='mt-3' />
                                          </div>
                                        )
                                      })}
                                    </div>
              ...
              <form onSubmit={(e) => { postReplies(e, x.disid.id, index); }}>
                <div onClick={() => {
                  setindex1(-1)
                  ...
                  <div className="input-group border rounded pe-lg-3 bg-light">
                    ...
                    <div className='d-flex align-items-center bg-light'>
                      ...
                      ><img src={require('../img/attachment.png')} width={22} height={22} alt="grp-disc" /></label>
                  ...
                  {repliesImage1.length > 0 &&
                    repliesImage1.map((image, index) => (
                      <div key={index} className="image-preview bg-light p-2" style={{ position: 'relative' }}>
                        ...
                        <button style={{ position: 'absolute', top: '-10px', right: '-16px' }} className='btn btn-sm' onClick={() => remove_Image1(index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
                    ...
                    <div className="input-group bg-light border rounded pe-lg-3">
                      ...
                      <div className='d-flex align-items-center bg-light'>
                        ...
                        <label data-bs-toggle="tooltip" data-bs-placement="top"
                          ...
                          <img src={require('../img/attachment.png')} width={22} height={22} alt="grp-disc" />
                        </label>
                ...
                <div className='d-flex gap-3'>
                  {replies_reply_Image1.length > 0 &&
                    replies_reply_Image1.map((image, index) => (
                      <div key={index} className="image-preview bg-light p-2" style={{ position: 'relative' }}>
                        <img src={URL.createObjectURL(image)} width={50} alt={`Selected Image ${index + 1}`} />
                        <button style={{ position: 'absolute', top: '-10px', right: '-16px' }} className='btn btn-sm' onClick={() => removereply_Image1(index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg></button>
                      </div>
