...
const Organizationdiscussion_offcanvases = ({ count, usercomments_status, setCount }) => {
  ...
  const fetchusercomments = () => {
    axiosInstance.get(`${ipaddress}/UserComments/${user.organization_id}/${user.user_id}/`)
      .then((r) => { setuserComments(r.data.reverse()) })
      .catch(() => { console.log("User Comments in organization fetching error") })
  }
  ...
  const pincomment = (discId) => {
    axiosInstance.post(`${ipaddress}/UniversityPinnedCommentsView/${user.user_id}/${discId}/${user.organization_id}/`)
      ...
      }).catch((err) => { console.log("UniversityPinnedCommentsView Error", err) })
  }
  // ---------------------------------------------------UNPIN COMMENT-------------------------------------------------------
  const unpin = (discid) => {
  ...
  return (
    <div>
      ...
      <div className="modal fade" id="usercommentsmodal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h6 className="modal-title" id="exampleModalLabel">Welcome <span style={{ color: '#5d5fe3' }}>{user.nickname}</span>, View your discussions here</h6>
              <button type="button" className='btn p-0' data-bs-dismiss="modal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-circle-fill" viewBox="0 0 16 16">
                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z" />
              </svg></button>
            </div>
            <div className="modal-body" style={{ height: '90vh', overflowY: 'scroll' }}>
                    ...
                    <div className='col-12 px-3 pe-4 pt-2 pb-3 rounded shadow-sm border mb-3 bg-white'>
                      <div className="row border-bottom py-3 m-0 align-items-center">
                        <div className="col-2 col-md-1 px-1 px-lg-0 d-flex justify-content-center">
                          <img src={x.user_id.profile_pic} className={x.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="uni-diss" />
                        ...
                        <div className={`col-7 p-0 ${x.pinned_status ? 'col-md-8' : 'col-md-9'}`} onClick={() => {
                          ...
                          <p className='ms-sm-0 my-0 d-flex align-items-center' style={{ fontSize: '12px', color: '#8587EA' }}>{user.program_name}  <span className={`ms-2 edit ${x.edited ? '' : 'd-none'}`}>Edited</span></p>
                        </div>
                                ...
                                <div className="modal-body">
                                  <div className=' bg-white px-3 pt-2 pb-3 rounded'>
                                    ...
                                    <div className='d-flex gap-3'>
                                      <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="uni-diss" />
                          ...
                          x.images_attached.map((z) => {
                            return (
                              <div className='d-flex justify-content-center'>
                                <img src={z.image} width={300} alt="uni-diss" className='mt-3' />
                              </div>
                            )
                          })
                        )}
                      ...
                      <div onClick={() => { setindex1(-1) }} className='d-flex justify-content-between border-bottom pt-3 pb-4 ps-2'>
                      ...
                      {fetchedreplies && fetchedreplies.length > 0 && (
                        <div className={fetchedreplies[0].udisid == x.id && replies_status ? 'd-block' : 'd-none'}>
                          {fetchedreplies.map((y, index2) => {
                            return (
                              <div key={index2} className='ps-0 ps-md-3 py-2 mt-3 bg-white' onClick={() => { setindex1(-1) }} >
                                <div className="row w-100 align-items-center">
                                  <div className="col-2 col-md-1 d-flex justify-content-center">
                                    <img src={y.user_id.profile_pic} className={y.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="uni-diss" />
                                ...
                                <div className='ps-0 ps-lg-5 mt-2 m-0'>
                                  ...
                                  {y.images_attached.map((a) => {
                                    return (
                                      <div className='d-flex justify-content-center'>
                                        <img src={a.organization_discussion_reply_images} width={300} alt="uni-diss" className='mt-3' />
                                      </div>
                                    )
                                  })}
                                    ...
                                    {fetchedreplies_for_reply && fetchedreplies_for_reply.length > 0 && (
                                      <div className={fetchedreplies_for_reply[0].reply == y.id && replies_for_reply_status ? 'd-block' : 'd-none'}>
                                        {fetchedreplies_for_reply.map((z) => {
                                          return (
                                            <div className='ps-0 ps-md-3 py-2 mt-3 bg-white' onClick={() => { setindex1(-1) }} >
                                              <div className="row w-100 align-items-center">
                                                <div className="col-2 col-md-1 d-flex justify-content-center">
                                                  <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="uni-diss" />
                                              ...
                                              <div className='ps-0 ps-lg-5 mt-2 m-0'>
                                                ...
                                                {z.images_attached.map((b) => {
                                                  return (
                                                    <div className='d-flex justify-content-center'>
                                                      <img src={b.organization_discussion_reply_reply_images} width={300} alt="uni-diss" className='mt-3' />
                                                    </div>
                                                  )
                                                })}
                                              </div>
                      ...
                      <div onClick={() => { setindex1(-1) }} className='d-flex gap-2 mt-3 pt-3 border-secondary-subtle align-items-center'>
                        <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="uni-diss" />
                        {userdetails.nickname != undefined ? (<p className={userdetails.profile_pic == null ? 'd-flex justify-content-center align-items-center bg-warning text-white rounded-circle my-auto' : 'd-none'} style={{ height: '40px', width: '40px' }}><span>{userdetails.nickname.slice(0, 1)}</span><span>{userdetails.nickname.slice(-1)}</span></p>) : (<></>)}
                        ...
                        {repliesImage5.length > 0 &&
                          repliesImage5.map((image, index) => (
                            <div key={index} className="image-preview bg-light p-2" style={{ position: 'relative' }}>
                              ...
                              <button style={{ position: 'absolute', top: '-10px', right: '-16px' }} className='btn btn-sm' onClick={() => removeImage5(index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
                    ...
                    <div className="input-group bg-light border rounded pe-3">
                      ...
                      <div className='d-flex align-items-center bg-light'>
                        ...
                        <label data-bs-toggle="tooltip" data-bs-placement="top"
                          ...
                          htmlFor="fileInput5"
                          className="custom-file-input bg-transparent border-0 px-4 py-2">
                          <img src={require('../img/attachment.png')} width={22} height={22} alt="uni-diss" />
                        </label>
                        <button disabled={reply_for_reply.length > 0 ? false : true} type='submit' className='text-secondary h-100 bg-transparent border-0 ms-2 outline-0' >
                          <svg data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-custom-class="custom-tooltip"
                ...
                <div className='d-flex gap-3 mt-3'>
                  {replies_reply_Image5.length > 0 &&
                    replies_reply_Image5.map((image, index) => (
                      <div key={index} className="image-preview bg-light p-2" style={{ position: 'relative' }}>
                        <img src={URL.createObjectURL(image)} width={50} alt={`Selected Image ${index + 1}`} />
                        <button style={{ position: 'absolute', top: '-10px', right: '-16px' }} className='btn btn-sm' onClick={() => removereply_Image5(index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg></button>
                      </div>
...
export default Organizationdiscussion_offcanvases;