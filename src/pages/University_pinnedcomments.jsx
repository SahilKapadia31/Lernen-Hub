...
const University_pinnedcomments = ({ count, pincomment_status, setCount }) => {
  ...
  const getpinnedcomments = () => {
    axiosInstance.get(`${ipaddress}/DisplayPinnedUniversityComments/${user.user_id}/${user.university_id}/`)
      .then((r) => {
    ...
    <div className={`${pincomment_status ? '' : 'd-none'}`}>
      {pinnedComments.length == 0 && (
        <>
          ...
          <h6 className={`text-center`} style={{ color: '#5d5fe3', fontSize: '14px' }}>No Followed comments available ...💬</h6>
        </>
      )}
      {pinnedComments && (
                        ...
                        <div key={index2} className='px-2 py-2 bg-white' onClick={() => {
                          ...
                          <div className='ps-5 mt-2 m-0'>
                            ...
                            {y.images_attached.map((a) => {
                              return (
                                <div className='d-flex justify-content-center'>
                                  <img src={a.university_discussion_reply_images} width={300} alt="uni-pin" className='mt-3' />
                                </div>
                              )
                            })}
                                      ...
                                      <div className='px-2 py-2 bg-white' onClick={() => {
                                        ...
                                        <div className='ps-0 ps-lg-5 mt-2 m-0'>
                                          ...
                                          {z.images_attached.map((b) => {
                                            return (
                                              <div className='d-flex justify-content-center'>
                                                <img src={b.university_discussion_reply_reply_images} width={300} alt="uni-pin" className='mt-3' />
                                              </div>
                                            )
                                          })}
                                        </div>
