    ...
    <div className={`${pinnedcomments_status ? '' : 'd-none'}`}>
      ...
      {pinnedComments.length > 0 && (
                ...
                <div className='col-12 bg-white px-3 pt-2 pb-3 rounded border'>
                  <div className="row align-items-center">
                    <div className="col-1" onClick={() => {
                      ...
                      <img src={x.user.profile_pic} className={x.user.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="shw-pdf-cmt" />
                  ...
                  <div className='py-2' onClick={() => {
                    ...
                    {x.comment.images_attached.map((z) => {
                      return (
                        <div>
                          <img src={z.image} width={300} className="mt-3 img-fluid" alt="shw-pdf-cmt" />
                        </div>
                      )
                    })}
                  </div>
       ...
       {x.liked_users.slice(0,5).map((a,index)=>{
         return(
           <>
            <img src="http://localhost:3000/static/media/man.ba3e9327f074cac4e49e.png" width={24} style={{left:`${index*20}px`,position:"absolute",top:'-2px'}} alt="shw-pdf-cmt" />
           </>
         )
       })}
       </div> */}
                          ...
                          <div className='py-2 mt-3' onClick={() => {
                            ...
                            <div className="row m-0 w-100 align-items-center">
                              <div className="col-1 p-0 d-flex justify-content-end">
                                <img src={y.user_details.profile_pic} className={y.user_details.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="shw-pdf-cmt" />
                            ...
                            <div className='ps-0 ps-lg-5 mt-2 m-0'>
                              ...
                              {y.image.map((a) => {
                                return (
                                  <div className=''>
                                    <img src={a.image} style={{ width: '100%' }} alt="shw-pdf-cmt" className='mt-3' />
                                  </div>
                                )
                              })}
                            </div>
                                      ...
                                      <div className={`ps-0 ${discussionpagelayout ? 'ps-md-3' : 'ps-md-0'} py-2 mt-3 bg-white`} onClick={() => {
                                        ...
                                        <div className="row w-100 align-items-center m-0">
                                          <div className="col-2 col-md-1 d-flex justify-content-center">
                                            <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="shw-pdf-cmt" />
                                          ...
                                          {z.images_attached.map((b) => {
                                            return (
                                              <div className='d-flex justify-content-center'>
                                                <img src={b.dis_reply_reply_images} width={260} alt="shw-pdf-cmt" className='mt-3' />
                                              </div>
                                            )
                                          })}
                                        </div>
                  ...
                  <div className='d-flex gap-2 mt-3 pt-3 border-secondary-subtle align-items-center' onClick={() => {
                    ...
                    <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="shw-pdf-cmt" />
            ...
            <div className="modal-body">
              <div className='col-12 bg-white px-3 pt-2 pb-3'>
                ...
                <div className='d-flex gap-3 align-items-center'>
                  <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="shw-pdf-cmt" />
                  ...
                  <div className="input-group bg-light border rounded pe-3">
                    ...
                    <div className='d-flex align-items-center bg-light'>
                      ...
                      <label
                        htmlFor="fileInput3"
                        className="custom-file-input bg-transparent border-0 px-4 py-2">
                        <img src={require('../img/attachment.png')} width={22} height={22} alt="shw-pdf-cmt" />
                      </label>
