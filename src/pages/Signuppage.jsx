          ...
          <div className="col-lg-6 mt-4 mt-lg-0 ">
            <div className='row m-0 mt-5 mt-lg-0 align-items-center' style={{ position: 'relative' }}>
              ...
              <div className='main-login align-items-center ' style={{ position: 'relative', padding: '20px' }}>
                ...
                {/* <img className='login-img1 d-none d-lg-block'style={{position:'absolute' ,animation: 'moveAnimation 6s linear infinite',width:'115px',height:'127px' }} src={require('../img//images_icons/Group-removebg-preview.png')} alt="sign-up" /> */}
                <img className='login-img1 d-none d-lg-block' style={{ position: 'absolute', animation: 'moveAnimation 6s linear infinite', width: '90px', height: '100px' }} src={require('../img//images_icons/Group-removebg-preview.png')} alt="sign-up" />
                {/* <img className='login-img2 d-none d-lg-block' style={{position:'absolute',height:'135px',width:'31px'}} src={require('../img/images_icons/login-image.png')} alt="sign-up" /> */}
                <img className='login-img2 d-none d-lg-block' style={{ position: 'absolute', height: '100px', width: '25px' }} src={require('../img/images_icons/login-image.png')} alt="sign-up" />
      ...
      <div className={state ? '' : 'd-none'} style={{ backgroundColor: 'rgba(0,0,0,0.5)', position: 'fixed', width: '100%', top: 0, height: '100%' }}>
        <div className="row m-0">
          <div className="bg-white col-md-8 col-lg-6 p-3 pt-4 rounded mx-auto mt-3">
            <p className='justify-content-center d-flex align-items-center m-0 fw-medium fs-5'><img src={require('../img/check__2_-removebg-preview.png')} width={30} alt="sign-up" className='me-2' />Request successfully sent to the Admin</p>
