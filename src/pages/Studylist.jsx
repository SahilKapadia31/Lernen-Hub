...
const validationSchema = Yup.object().shape({
  study_list_name: Yup.string().required("Study list name required"),
});
...
const Studylist = () => {
  ...
  const [isEditStudyListName, setIsEditStudyListName] = useState(false);
  ...
  const editStudylist = (value) => {

    setIsEditStudyListName(false);
    const formdata = new FormData()
    formdata.append('study_list_id', study_list_id)
    formdata.append('study_list_name', value.study_list_name)
      ...
      {loading ? (<Preloader />) : (
        <div>
          ...
          <div className="d-flex" style={{ minHeight: '100vh' }}>
            ...
            }} className="container-fluid main-division bg-light">
              <div onClick={() => {
                setnavbar_dropdown_visible(false)
              }} className="w-100 mt-3">
                <div className='container pb-5 pt-3 pt-lg-5 studylist-div position-relative' >
                  <div className="d-flex justify-content-between align-items-center" style={{ position: 'relative' }}>
                    <h5 className='m-0 fw-medium text-white' style={{ textTransform: 'capitalize' }}>{studylist_details.study_list_name}</h5>
                    <div style={{ position: 'relative' }}>
                      <button className="btn border-0 text-white"  onClick={() => {
                      ...
                      <ul className={`bg-white rounded border p-0 px-2 py-2 ${dropdownstate ? '' : 'd-none'}`} style={{ position: 'absolute',right:'35px',top:'6px', listStyleType: 'none', zIndex: 10, marginBottom: 0 }}>
                        <li style={{ cursor: "pointer" }} onClick={() => { setIsEditStudyListName(!isEditStudyListName) }}><a className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        ...
                        <li style={{ cursor: "pointer" }} onClick={() => { setDeleteConfirmation(true) }} className='mt-2'><a className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                  ...
                  <div onClick={() => { setdropdownstate(false) }} className='d-flex py-2 gap-3 flex-column flex-lg-row'>
                    <span className={`text-white d-flex align-items-center gap-2 ${pendingstudylists.length > 0 || completedstudylists.length > 0 ? '' : 'd-none'}`}><svg style={{ width: '25px' }} xmlns="http://www.w3.org/2000/svg" width="15" height="19" viewBox="0 0 15 19" fill="none">
                  ...
                  <div onClick={() => { setdropdownstate(false) }} className='w-100 d-flex justify-content-center mt-3' style={{ position: 'absolute', left: 0 }}>
                    <div className="input-group bg-white rounded shadow-sm w-75 ">
                ...
                <ul onClick={() => {
                  setdropdownstate(false)
                }} className="container nav nav-underline bg-white py-2 rounded shadow-sm mt-md-5 mt-5 px-lg-3" id="myTab" role="tablist">
                ...
                <div className="tab-content" id="myTabContent" onClick={() => {
                  ...
                  {/* ---------------------------------------------PENDING DOCUMENTS--------------------------------------------------- */}
                  <div className="container tab-pane fade show active bg-light mt-2" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                    ...
                    <div className="row">
                      ...
                      <div className={`col-12 ${pendingstudylists.length > 0 ? '' : 'd-none'} px-0`}>
                        <div className='d-flex justify-content-between bg-light py-3 px-0 align-items-center'>
                          <span className='fw-bold' style={{ color: '#8E9696' }}>{pendingstudylists.length} Documents</span>
                          <select name="" id="filter" className='border px-2 py-2 bg-light' onChange={(e) => {
                                ...
                                <div className="row m-0 align-items-center">
                                  ...
                                  <div className="col-10 col-lg-10 ms-md-0 d-flex flex-column justify-content-center ">
                                    <div className="row m-0 border-bottom">
                                      <Link className='fw-bold d-none d-md-inline text-decoration-none text-primary w-100'  to={`/showpdf/${x.document.id}`}>{x.document.title}</Link>
                                      <Link className='fw-bold d-inline d-md-none text-decoration-none text-primary w-100'  to={`/showpdf/${x.document.id}`}>{x.document.title.slice(0,20)}</Link>
                                    ...
                                    <div className="d-flex align-items-center justify-content-between mt-2">
                                      <div className='d-flex gap-2 align-items-center'>
                                        <span style={{ fontSize: '14px', color: '#AAB0B0' }} className='d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
                                        ...
                                        <span style={{ fontSize: '14px', color: '#AAB0B0' }} className='d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                              ...
                              <div className='shadow-sm mb-3 py-3 px-2 px-lg-0 rounded bg-white'>
                                <div className="row m-0 align-items-center">
                                  ...
                                  <div className="col-10 col-md-10 ms-md-0 d-flex flex-column justify-content-center ">
                                    <div className="row m-0 border-bottom">
                                      <Link className='fw-bold d-none d-md-inline text-decoration-none text-primary w-100'  to={`/showpdf/${x.document_id}`}>{x.title}</Link>
                                      <Link className='fw-bold d-inline d-md-none text-decoration-none text-primary w-100'  to={`/showpdf/${x.document_id}`}>{x.title.slice(0,20)}</Link>
                                      <p className='mt-1 d-flex align-items-center' style={{ fontSize: '14px', color: '#5D5FE3' }}>
                  ...
                  {/* ---------------------------------------------COMPLETED DOCUMENTS------------------------------------------------- */}
                  <div className="container tab-pane fade show bg-light mt-2 px-0" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex="0">
                    <div className="row">
                      ...
                      <div className={`col-12 ${completedstudylists.length > 0 ? '' : 'd-none'}`}>
                        <div className='d-flex justify-content-between bg-light py-3 align-items-center'>
                          ...
                          {filtereddocuments.map((x) => {
                            return (
                              <div className='shadow-sm mb-3 py-2 px-2 px-lg-0 bg-white'>
                                <div className="row m-0 align-items-center">
                                  <div className="col-3 col-lg-2 d-flex align-items-center justify-content-center" style={{ overflow: 'hidden' }}>
                                    <Document file={x.document} onLoadSuccess={() => console.log('Document loaded successfully.')}>
                                      <Page pageNumber={1} scale={0.3} width={280} /> {/* Adjust the scale to make the page smaller */}
                                    </Document>
                                  </div>
                                  <div className="col-9 col-md-10 ms-md-0 d-flex flex-column justify-content-center ">
                                    <div className="row m-0 border-bottom">
                                      <Link className='fw-bold d-none d-md-inline text-decoration-none text-primary w-100' to={`/showpdf/${x.document_id}`}>{x.title}</Link>
                                      <Link className='fw-bold d-inline d-md-none text-decoration-none text-primary w-100' to={`/showpdf/${x.document_id}`}>{x.title.slice(0,20)}</Link>
                                      <p className='mt-1 d-flex align-items-center' style={{ fontSize: '14px', color: '#5D5FE3' }}>
          ...
          <Modal isOpen={isEditStudyListName} size='md' centered>
            <Formik
              initialValues={initialValues}
              validationSchema={validationSchema}
              onSubmit={editStudylist}
            >
                  ...
                  <div className='px-4 py-4'>
                    ...
                    <div className='mt-3'>
                      <div className={`d-flex mt-3 flex-column`}>
                        <input
                          type="text"
                          name='study_list_name'
                          className='form-control'
                          placeholder='Enter Study List Name'
                          value={values.study_list_name}
                          onChange={handleChange}
                          onBlur={handleBlur} />
                        <ErrorMessage className="validation-error" name='study_list_name' component='div' />
                        <div className='d-flex gap-3 mt-3 justify-content-center'>
                          <button type='submit' className='btn text-white fw-medium ms-2 px-3' style={{ backgroundColor: '#5D5FE3' }}>Update</button>
                          <button type='button' className='btn fw-medium ms-2 px-3' style={{ border: '1px solid #606060', color: '#606060' }} onClick={() => { setIsEditStudyListName(false) }}>Cancel</button>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Modal size='md' isOpen={deleteConfirmation}>
            <div className='p-4'>
              <p>Are you sure you want to delete ?</p>
              <div className='d-flex align-items-center gap-3 justify-content-center mt-2'>
                <button className='btn btn-primary' onClick={deleteStudylist}>Ok</button>
                <button className='btn btn-danger' onClick={() => { setDeleteConfirmation(false) }}>Cancel</button>
              </div>
            </div>
          </Modal>
