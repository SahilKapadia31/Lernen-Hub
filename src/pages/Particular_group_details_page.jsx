...
const Particular_group_details_page = ({ group_id }) => {
  ...
  return (
    <div>
      <div className="modal fade" id="group_details_modal" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-body pt-4 pb-3">
              <div className='row m-0'>
                <div className="col-sm-6 d-flex align-items-center">
                  <img src={groupdetails.group_image} style={{ width: '100%' }} alt="pr-grp" />
                </div>
