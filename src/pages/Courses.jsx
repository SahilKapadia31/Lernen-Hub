...
const Courses = () => {
  ...
  useEffect(() => {
    setUserdata(JSON.parse(getDecryptedData('user')));
  ...
  return (
   ...
   {/* ******************************End****************---courses page add button  by Bteam  */}
               ...
               {/* ------------------------------------------------Older info-------------------------------------------- */}
                ...
                <div className=" mt-4">
                  <ul className={`view-doc ps-0 pb-3 ${SearchedSubjects.length > 0 ? 'd-block' : 'd-none'}`} style={{ listStyleType: 'none' }}>
                  ...
                  <ul className={`view-doc ps-0 ${courses.length > 0 ? 'd-block' : 'd-none'}`} style={{ listStyleType: 'none' }}>
                    <h5 className='page6-head m-0 d-flex align-items-center'><span className='page6-month'>{translate_value.common_words.recommended_courses}</span></h5>
                    {courses.map((x, index) => {
                      return (
                        <li className='mb-3 py-3 rounded px-2 shadow-sm d-flex align-items-center px-4 bg-white' key={index}>
                          <div className='d-flex flex-column'>
                  ...
                  <ul className={`view-doc ps-0 ${joinedcourses.length > 0 ? 'd-block' : 'd-none'}`} style={{ listStyleType: 'none' }}>
                    ...
                    <h5 className='page6-head m-2 d-flex align-items-center'><span className='page6-month'>{translate_value.common_words.joined_courses}</span></h5>
