...
const University_discussion_offcanvases = ({ count, usercomments_status, setCount }) => {
  ...
  const fetchusercomments = () => {
    axiosInstance.get(`${ipaddress}/UserComments/${user.university_id}/${user.user_id}/`)
      .then((r) => { setuserComments(r.data.reverse()) })
      .catch(() => { console.log("User Comments in university fetching error") })
  }
                              ...
                              <div key={index2} className='ps-0 ps-md-3 py-2 mt-3 bg-white' onClick={() => { setindex1(-1) }} >
                                ...
                                <div className='ps-0 ps-lg-5 mt-2 m-0'>
                                  ...
                                  {y.images_attached.map((a) => {
                                    return (
                                      <div className='d-flex justify-content-center'>
                                        <img src={a.university_discussion_reply_images} width={300} alt="uni-diss" className='mt-3' />
                                      </div>
                                    )
                                  })}
                                            ...
                                            <div className='ps-0 ps-md-3 py-2 mt-3 bg-white' onClick={() => { setindex1(-1) }} >
                                              ...
                                              <div className='ps-0 ps-lg-5 mt-2 m-0'>
                                                ...
                                                {z.images_attached.map((b) => {
                                                  return (
                                                    <div className='d-flex justify-content-center'>
                                                      <img src={b.university_discussion_reply_reply_images} width={300} alt="uni-diss" className='mt-3' />
                                                    </div>
                                                  )
                                                })}
                                              </div>
