...
const Group_document_upload = () => {
  ...
  setEncryptedData("path3", JSON.stringify(`/group_upload_page/${group_id}`), 180);
  // const category=(e)=>{
  ...
  const subcategoryData = (e) => {
    ...
    switch (value) {
      ...
      case "notes":
        ...
        break;
      default:
        break; // No need to set anything, as all states are already reset
    }
  };
  ...
  const chapternameData = (e) => {
    ...
    if (e.target.value.length > 0) {
      axiosInstance.get(`${ipaddress}/ChapterSuggestions/${e.target.value}/`)
        ...
        }).catch(() => {console.log("Chapter names fetching Error")})
    }
  }
  ...
  useEffect(() => {
    ...
    axiosInstance.get(`${ipaddress}/Semesters/`)
      ...
      }).catch(() => { console.log("Semester Error") })
    ...
    axiosInstance.get(`${ipaddress}/subCategoryView/`)
      ...
      }).catch(() => { console.log("Sub Category data Error") })
  }, [])
  ...
  const fetch_chapter = (id) => {
    axiosInstance.get(`${ipaddress2}/SendChapterName/${categoryid}/${id}/`)
      ...
      }).catch((err) => {console.log("Course_id", categoryid)})
  }
  const isButtonDisabled = !(document_title && categoryid && subcategoryid);
  return (
    <div>
      <div className="d-flex">
        ...
        }} className='container' style={{ backgroundColor: '#F9F9FB' }}>
          <Navpath />
          <div onClick={() => {setnavbar_dropdown_visible(false)}}>
            <div className="container pb-5 pt-3" style={{ position: 'relative', backgroundColor: '#F3F0FF', height: '150px' }}>
              <div id='uploadimg' className='rounded-circle bg-white border p-2' style={{ position: 'absolute', top: '100px' }}>
                <img src={require('../img/images_icons/send-img2.png')} width={80} alt="grp-doc" />
              </div>
            </div>
                ...
                <div className='row shadow-sm py-3 py-md-4 mx-auto d-flex justify-content-center bg-white align-items-center px-3'>
                  ...
                  <div className="mb-4 col-md-6">
                    ...
                    <select
                      ...
                      onChange={(e) => {setCategoryIdid(e.target.value)}}
                      value={categoryid}
                    >
                  ...
                  <div className='mt-4 text-center'>
                    <button disabled={isButtonDisabled} className='btn text-white fw-medium' style={{ backgroundColor: '#5D5FE3' }} onClick={() => {
                      document.getElementById('details').style.display = 'none'
              ...
              <section className="row justify-content-center mt-4" id='finalstep' style={{ display: 'none' }}>
                ...
                <div className="col-lg-9 col-md-10 rounded text-center mx-auto pt-2 pb-3 bg-white shadow-sm">
                  ...
                  <div className='py-5 rounded px-4 mt-4' style={{ border: '1px dashed #5D5FE3', backgroundColor: '#CFF4D2' }}>
                    <img className='animate__animated animate__bounceIn' src={require('../img/checkmark-removebg-preview.png')} width={50} alt="grp-doc" />
