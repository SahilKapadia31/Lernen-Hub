      ...
      {loading ? (<Preloader />) : (
        <div>
          <div className="d-flex bg-light" style={{ minHeight: '100vh' }}>
            <div onClick={() => { setcourse_visible(false); setgroup_visible(false); setstudylist_visible(false) }} className="container main-division">
              
              <div onClick={() => { setnavbar_dropdown_visible(false) }} className="w-100 mt-3">
                <div className='container pb-5 pt-3 pt-lg-5 studylist-div' style={{ position: 'relative' }}>
                  <div className="d-flex justify-content-between align-items-center" style={{ position: 'relative' }}>
                    <h5 className='m-0 fw-medium text-white' style={{ textTransform: 'capitalize' }}>{studylist_details.study_list_name_text}</h5>
                    <div>
                      <button className="btn border-0 text-white" style={{ position: 'relative' }} onClick={() => { setdropdownstate(!dropdownstate) }}>
                      ...
                      <ul className={`bg-white rounded border p-0 px-2 py-2 ${dropdownstate ? '' : 'd-none'}`} style={{ position: 'absolute',right:'35px',top:'6px', listStyleType: 'none', zIndex: 10, marginBottom: 0 }}>
                        <li style={{ cursor: 'pointer' }} onClick={() => { setIsEditFlashcard(!isEditFlashcard) }}>
                          <a className="dropdown-item">
                            ...
                            </svg> <span className='ms-2'>Edit Study List Name</span>
                          </a>
                        </li>
                        <li onClick={()=>{setDeleteConfirmation(true)}} style={{ cursor: 'pointer' }} className='mt-2'>
                          <a className="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                            ...
                            </svg> <span className='ms-2'>Delete Study List</span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div onClick={() => { setdropdownstate(false) }} className='d-flex py-2 gap-3 flex-column flex-lg-row'>
                    <span className={`text-white d-flex align-items-center gap-2`}>
                      ...
                      <span style={{ fontSize: '14px' }}>{studylist_details.flashset_count} Flashsets</span>
                    </span>
                    <span className='text-white d-flex align-items-center gap-2'>
                      ...
                      <span style={{ fontSize: '14px' }}>{studylist_details.studylist_created_date}</span>
                    </span>
                    <span className='text-white d-flex align-items-center gap-2'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                      ...
                      <span style={{ fontSize: '14px' }}>Communication Design</span>
                    </span>
                  </div>
                  <div onClick={() => { setdropdownstate(false) }} className='w-100 d-flex justify-content-center mt-3' style={{ position: 'absolute', left: 0 }}>
                    <div className="input-group bg-white rounded shadow-sm w-75">
                      <span className="input-group-text bg-white border-0 py-3 px-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                      ...
                      <input onChange={(e) => { searchFlashset(e.target.value) }} type="text" className="form-control bg-white border-0 py-2 py-lg-3" placeholder="Search Documents in your study lists" aria-label="Username" aria-describedby="basic-addon1" />
                    </div>
                  </div>
                </div>

                {/* --------------------------------------------TABLIST--------------------------------------------------------------- */}
                <ul onClick={() => { setdropdownstate(false) }} className="container nav nav-underline bg-white py-2 rounded shadow-sm mt-md-5 mt-5 px-lg-3" id="myTab" role="tablist">
                ...
                <div onClick={() => { setdropdownstate(false) }} className="tab-content" id="myTabContent">
                  {/* ---------------------------------------------FLASHSETS--------------------------------------------------- */}
                  <div className="container tab-pane fade show active mt-2 bg-light px-0" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                    <div className="row">
                          ...
                          {studylists_flashsets.map((x) => {
                            return (
                              <div className='shadow-sm mb-3 py-3 px-2 px-lg-0 rounded bg-white'>
                                <div className="d-flex gap-2 gap-lg-4 px-2 px-lg-3">
                                  <div className="col-2 d-flex align-items-center justify-content-center rounded" style={{ backgroundColor: '#CFF4D2', width: '100px' }}>
                                  ...
                                  <div className="d-flex flex-column justify-content-center w-100">
                                    <div className="border-bottom mb-0">
                                      <div className='d-flex justify-content-between'>
                                        <Link to={`/viewflashcard/'study_list'/${study_list_id}/${x.flashset_details.flashset_id}`} onClick={()=>sessionStorage.setItem('selectedSubTab','flashcard_studylist')} className='fw-bold w-100 text-decoration-none text-primary' style={{ color: '#2A3941' }}>{x.flashset_details.name}</Link>
                                      </div>
                                    ...
                                    <div className="d-flex align-items-center gap-3 mt-2">
                                      <span style={{ fontSize: '14px', color: '#AAB0B0' }} className='d-flex align-items-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        ...
                                        <span className='ms-2'>{x.flashset_details.upvote_count} <span className='d-lg-inline d-none'>Likes</span>
                                        </span>
                                      </span>
                                      <span style={{ fontSize: '14px', color: '#AAB0B0' }} className='d-flex align-items-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        ...
                                        <span className='ms-2'>{x.flashset_details.flashcards_count} <span className='d-lg-inline d-none'>Flashcards</span></span>
                                      </span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className='shadow-sm mb-3 py-3 px-2 px-lg-0 rounded bg-white'>
                                <div className="d-flex gap-2 gap-lg-4 px-2 px-lg-3">
                                  ...
                                  <div className="d-flex flex-column justify-content-center w-100">
                                    <div className="border-bottom mb-0">
                                      <div className='d-flex justify-content-between'>
                                        <Link to={`/viewflashcard/'study_list'/${study_list_id}/${x.flashset_id}`} className='fw-bold w-100 text-decoration-none text-primary'>{x.name}</Link>
                                      </div>
                                      <p className='mt-1' style={{ fontSize: '14px', color: '#5D5FE3' }}>
                                    ...
                                    <div className="d-flex align-items-center gap-3 mt-2">
                                      ...
                                      <span style={{ fontSize: '14px', color: '#AAB0B0' }} className='d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path d="M6.66669 16.1536V8.00778C6.66669 7.63492 6.79863 7.31815 7.06252 7.05747C7.32641 6.79679 7.64479 6.66645 8.01765 6.66645H16.1539C16.5267 6.66645 16.8443 6.79758 17.1066 7.05986C17.3689 7.32215 17.5 7.63973 17.5 8.01259V13.8139L13.8141 17.4998H8.01284C7.63997 17.4998 7.3224 17.3686 7.06011 17.1064C6.79783 16.8441 6.66669 16.5265 6.66669 16.1536ZM2.52086 5.49657C2.4482 5.12371 2.51978 4.78797 2.73559 4.48936C2.95141 4.19075 3.24575 4.00512 3.61861 3.93247L11.6346 2.52061C12.0075 2.44796 12.3432 2.51954 12.6419 2.73534C12.9405 2.95116 13.1261 3.2455 13.1988 3.61836L13.375 4.67926H12.5321L12.3542 3.68567C12.3328 3.56815 12.2687 3.47467 12.1619 3.40524C12.055 3.33579 11.9375 3.31175 11.8093 3.33311L3.76604 4.76101C3.61647 4.78237 3.50429 4.85181 3.4295 4.96932C3.35472 5.08685 3.32802 5.2204 3.34938 5.36997L4.6795 12.8828V14.4966C4.48934 14.4036 4.32774 14.2717 4.19473 14.1007C4.06172 13.9298 3.97438 13.7338 3.93271 13.5126L2.52086 5.49657ZM7.50002 8.01259V16.1536C7.50002 16.3032 7.5481 16.4261 7.64425 16.5222C7.74041 16.6184 7.86327 16.6664 8.01284 16.6664H13.3334V13.3331H16.6667V8.01259C16.6667 7.86302 16.6186 7.74016 16.5225 7.64401C16.4263 7.54785 16.3034 7.49978 16.1539 7.49978H8.01284C7.86327 7.49978 7.74041 7.54785 7.64425 7.64401C7.5481 7.74016 7.50002 7.86302 7.50002 8.01259Z" fill="#8E9696" />
          ...
          <Modal isOpen={isEditFlashcard} size='md' centered>
            <Formik
                    ...
                    <div className='mt-3'>
                      <div className={`d-flex mt-3 flex-column`}>
                        ...
                        <div className='d-flex gap-3 mt-3 justify-content-center'>
                          ...
                          <button type='button' className='btn fw-medium ms-2 px-3' style={{ border: '1px solid #606060', color: '#606060' }} onClick={() => { setIsEditFlashcard(!isEditFlashcard) }} >Cancel</button>
                        </div>
                      </div>
                    </div>
                  </div>
