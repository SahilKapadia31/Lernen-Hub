        ...
        return (
          <div className='mt-3' key={index}>
            <div className='rounded shadow-sm border'>
              <div className="d-flex justify-content-between border-bottom py-2 ps-2 align-items-center">
                <div className='d-flex gap-2 align-items-center'>
                  <div className="d-flex justify-content-center" onClick={() => {
                    setindex1(-1)
                    // setreportdropdownstate(false)
                  }}>
                    <img src={x.user_details.profile_pic} className={x.user_details.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="sub-ser" />
                ...
                <p className='my-0 d-flex align-items-center' style={{ fontSize: '12px', color: '#8587EA', cursor: 'pointer' }} onClick={() => {
                  ...
                  <div className="btn-group dropstart">
                    ...
                    <ul className={`bg-white shadow-sm border rounded mt-0 p-0 px-3 ${index1 == index ? '' : 'd-none'}`} style={{ width: '160px', position: 'absolute', left: '-160px' }}>
                      ...
                      {user.user_id !== x.user_details.user_id &&
                        <>
                          <button onClick={() => {
                        ...
                        <div className="modal-body">
                          <div className=' bg-white px-3 pt-2 pb-3 rounded'>
                            ...
                            <div className='d-flex gap-3'>
                              <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="sub-ser" />
              ...
              <div className='py-2 px-2' onClick={() => {
                ...
                {x.images_attached && (
                  x.images_attached.map((z) => {
                    return (
                      <div>
                        <img src={z.image} width={300} alt="sub-ser" className='mt-3' />
                      </div>
                    )
                  })
                )}
                        ...
                        <div className="d-flex align-items-center justify-content-between w-100 px-2">
                          <div className='d-flex gap-2'>
                            <div className="d-flex justify-content-end">
                              <img src={y.user.profile_pic} className={y.user.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="sub-ser" />
                          ...
                          {y.images_attached.map((a) => {
                            return (
                              <div className='d-flex justify-content-center'>
                                <img src={a.doc_reply_images} width={300} alt="sub-ser" className='mt-3' />
                              </div>
                            )
                          })}
                        </div>
                                ...
                                return (
                                  <div className='px-2 py-2' onClick={() => {
                                    ...
                                    <div className="d-flex justify-content-between w-100 align-items-center">
                                      <div className='d-flex gap-2'>
                                        <div className="d-flex justify-content-center">
                                          <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="sub-ser" />
                                    ...
                                    <div className='ps-5 mt-2 m-0'>
                                      ...
                                      {z.images_attached.map((b) => {
                                        return (
                                          <div className='d-flex justify-content-center'>
                                            <img src={b.dis_reply_reply_images} width={260} alt="sub-ser" className='mt-3' />
                                          </div>
                                        )
                                      })}
                                    </div>
                    ...
                    <div className="input-group bg-light border rounded pe-3">
                      ...
                      <div className='d-flex align-items-center bg-light'>
                        ...
                        <label data-bs-toggle="tooltip" data-bs-placement="top"
                          ...
                          htmlFor="fileInput4"
                          className="custom-file-input bg-transparent border-0 px-lg-4 py-2">
                          <img src={require('../img/attachment.png')} width={22} height={22} alt="sub-ser" />
                        </label>
