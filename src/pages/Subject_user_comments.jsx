...
const Subject_user_comments = ({ course_id, usercomment_status, course_name, setCount }) => {
  ...
  const fetchuser_comments = () => {
    axiosInstance.get(`${ipaddress}/usercoursecomments/${user.user_id}/${course_id}/`)
      .then((r) => {
            ...
            <div className='rounded shadow-sm border'>
              <div className="d-flex justify-content-between border-bottom py-2 ps-2 m-0 align-items-center">
                <div className='d-flex gap-2 align-items-center'>
                  <div className="d-flex justify-content-center" onClick={() => { setindex1(-1) }}>
                    <img src={x.user_details.profile_pic} className={x.user_details.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="sub-comt" />
                ...
                <div className={`ps-4 d-flex align-items-center p-0 gap-2`}>
                ...
                <p className='my-0 d-flex align-items-center' style={{ fontSize: '12px', color: '#8587EA', cursor: 'pointer' }} onClick={() => {
                  ...
                  <div className="btn-group dropstart">
                    ...
                    <ul className={`bg-white shadow-sm border rounded mt-0 p-0 px-3 ${index1 == index ? '' : 'd-none'}`} style={{ width: '160px', position: 'absolute', left: '-160px' }}>
                      ...
                      <button className={`bg-transparent border-0 ${user.user_id === x.user_details.user_id ? 'd-flex align-items-center my-2' : 'd-none'}`} onClick={() => {
                        deletePost(x.discid)
                      }} style={{ height: '20px' }}><span className='dropdownmenu'><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 30 30" fill="none">
                        ...
                        <div className="modal-body">
                          <div className=' bg-white px-3 pt-2 pb-3 rounded'>
                            ...
                            <div className='d-flex gap-3'>
                              <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="sub-comt" />
              ...
              <div className='py-2 px-2' onClick={() => {
                ...
                {x.images_attached && (
                  x.images_attached.map((z) => {
                    return (
                      <div>
                        <img src={z.image} width={300} alt="sub-comt" className='mt-3' />
                      </div>
                    )
                  })
                )}
                        ...
                        <div className="d-flex px-2 justify-content-between align-items-center w-100">
                          <div className='d-flex gap-2'>
                            <div className="d-flex justify-content-end">
                              <img src={y.user.profile_pic} className={y.user.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="sub-comt" />
                          ...
                          <div className="p-0 d-flex gap-3 justify-content-between">
                            ...
                            <button className={user.user_id === y.user.user_id ? 'bg-transparent border-0 ms-1 d-flex align-items-center' : 'd-none'} onClick={() => {
                          ...
                          {y.images_attached.map((a) => {
                            return (
                              <div className='d-flex justify-content-center'>
                                <img src={a.doc_reply_images} width={300} alt="sub-comt" className='mt-3' />
                              </div>
                            )
                          })}
                        </div>
                                ...
                                return (
                                  <div className='py-2 px-2' onClick={() => {
                                    ...
                                    <div className="d-flex justify-content-between w-100 align-items-center">
                                      <div className='d-flex gap-2'>
                                        <div className="d-flex justify-content-center">
                                          <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="sub-comt" />
                                    ...
                                    <div className='ps-5 mt-2 m-0'>
                                      ...
                                      {z.images_attached.map((b) => {
                                        return (
                                          <div className='d-flex justify-content-center'>
                                            <img src={b.dis_reply_reply_images} width={260} alt="sub-comt" className='mt-3' />
                                          </div>
                                        )
                                      })}
                                    </div>
              ...
              <div onClick={() => {
                ...
                <form className='w-100' onSubmit={(e) => postReplies(e, x.discid, index)}>
                  <div className="input-group border rounded pe-lg-3 bg-light">
                    <input key={index}
                      type="text"
                      // value={replies}
                      onChange={(e) => { repliesData(e); setSelectedPostForComment(x.discid) }}
                      className="form-control py-2 ps-3 shadow-none border-0 bg-light user-reply-input" placeholder={translate_value.dashboard.reply_here}
                      style={{ position: 'relative' }} />
                    <div className='d-flex align-items-center bg-light'>
                      ...
                      >
                        ...
                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                          data-bs-custom-class="custom-tooltip"
                          data-bs-title="Post" xmlns="http://www.w3.org/2000/svg" className={`${(load && selectedPostForComment == x.discid) ? 'd-none' : ''}`} width="25" height="25" viewBox="0 0 30 30" fill="none">
                          <path d="M5 23.125V6.875L24.2789 15L5 23.125ZM6.25 21.25L21.0625 15L6.25 8.75V13.6058L12.3077 15L6.25 16.3942V21.25Z" fill="#8E9696" />
                        </svg>
                      </button>
                    </div>
                    ...
                    <div className="input-group bg-light border rounded pe-3">
                      ...
                      <div className='d-flex align-items-center bg-light'>
                        ...
                        <label data-bs-toggle="tooltip" data-bs-placement="top"
                          ...
                          htmlFor="fileInput1"
                          className="custom-file-input bg-transparent border-0 px-lg-4 py-2">
                          <img src={require('../img/attachment.png')} width={22} height={22} alt="sub-comt" />
                        </label>
