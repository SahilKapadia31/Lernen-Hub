...
const Globalsearch = () => {
  ...
  //       }).catch(() => { console.log("Global Search Error") })
  //   } else {
  //     setstatus(false)
  //   }
  // }
  ...
  const globalsearch = async (value) => {
    ...
    if (value.length > 0) {
      try {
        ...
        console.log("Global Search Data Found: setdocumentData", ResponseResult?.documents);
      } catch (error) {
        console.error("Global Search Error:", error);
      }
    } else {
      setstatus(false);
      // Reset the data states when search value is empty
