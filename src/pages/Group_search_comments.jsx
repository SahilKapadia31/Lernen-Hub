              ...
              <div className="d-flex justify-content-between border-bottom py-2 ps-2 align-items-center mb-0">
                <div className='d-flex gap-2 align-items-center'>
                  <div className="d-flex justify-content-center" onClick={() => {
                    ...
                    <img src={x.sender.profile_pic} className={x.sender.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="grp-ser" />
                ...
                <div className={`d-flex align-items-center gap-2`} style={{ position: 'relative' }}>
                  ...
                  <div className="btn-group dropstart">
                    <span className={`border-0`} type="button" style={{ cursor: 'pointer' }} onClick={() => {
                      ...
                      <img src={require('../img/more.png')} width={30} height={30} alt="grp-ser" />
                    </span>
                        ...
                        <div className="modal-body">
                          <div className=' bg-white px-3 pt-2 pb-3 rounded'>
                            ...
                            <div className='d-flex gap-3'>
                              <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="grp-ser" />
              ...
              <div className='py-2 px-2' onClick={() => {
                ...
                {x.images_attached && (
                  x.images_attached.map((z) => {
                    return (
                      <div>
                        <img src={z.images} width={200} alt="grp-ser" className='mt-3' />
                      </div>
                    )
                  })
                )}
                      ...
                      <div className='px-2 py-2 bg-white' onClick={() => {
                        ...
                        <div className="d-flex px-2 justify-content-between w-100 align-items-center">
                          <div className='d-flex gap-2'>
                            <div className="d-flex justify-content-end">
                              <img src={y.user_id.profile_pic} className={y.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="grp-ser" />
                        ...
                        <div className='ps-5 mt-2'>
                          ...
                          {y.images_attached.map((a) => {
                            return (
                              <div className=''>
                                <img src={a.images} width={300} alt="grp-ser" className='mt-3' />
                              </div>
                            )
                          })}
                        </div>
                                  ...
                                  <div className='py-2 px-2 bg-white' onClick={() => {
                                    ...
                                    <div className="d-flex justify-content-between w-100 align-items-center">
                                      <div className='d-flex gap-2'>
                                        <div className="d-flex justify-content-center">
                                          <img src={z.user_id.profile_pic} className={z.user_id.profile_pic == null ? 'd-none' : 'rounded-circle'} width={30} height={30} alt="grp-ser" />
                                    ...
                                    <div className='ps-5 mt-2'>
                                      ...
                                      {z.images_attached.map((b) => {
                                        return (
                                          <div className='d-flex justify-content-center'>
                                            <img src={b.Group_Discussion_Replies_Reply_Images} width={260} alt="grp-ser" className='mt-3' />
                                          </div>
                                        )
                                      })}
                                    </div>
                ...
                <div onClick={() => {
                  ...
                  <div className="input-group border rounded pe-lg-3 bg-light">
                    <input key={index}
                      ...
                      className="form-control py-2 ps-3 shadow-none border-0 bg-light search-reply-input" placeholder={translate_value.dashboard.reply_here}
                      style={{ position: 'relative' }} />
                    <div className='d-flex align-items-center bg-light'>
                      ...
                      ><img src={require('../img/attachment.png')} width={22} height={22} alt="grp-ser" /></label>
            ...
            <div className="modal-body">
              <div className='col-12 bg-white px-lg-3 pt-2 pb-3'>
                ...
                <div className='d-flex gap-lg-3 gap-1 align-items-center'>
                  <img src={userdetails.profile_pic} className={userdetails.profile_pic == null ? 'd-none' : 'rounded-circle'} width={40} height={40} alt="grp-ser" />
                  {userdetails.nickname != undefined ? (<p className={userdetails.profile_pic == null ? 'd-flex justify-content-center align-items-center bg-warning text-white rounded-circle my-auto' : 'd-none'} style={{ height: '40px', width: '40px' }}><span>{userdetails.nickname.slice(0, 1)}</span><span>{userdetails.nickname.slice(-1)}</span></p>) : (<></>)}
                  <form onSubmit={postreply_for_replies} className='w-100'>
                    <div className="input-group bg-light border rounded pe-lg-3">
                      ...
                      <div className='d-flex align-items-center bg-light'>
                        ...
                        <label data-bs-toggle="tooltip" data-bs-placement="top"
                          ...
                          <img src={require('../img/attachment.png')} width={22} height={22} alt="grp-ser" />
                        </label>
